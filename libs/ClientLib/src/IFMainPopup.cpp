...
bool CIFMainPopup::OnCreate(long ln) {
    ...
    m_btnInventory->ShowGWnd(true);
    m_btnSkill->ShowGWnd(true);
    m_btnAction->ShowGWnd(true);
    m_btnParty->ShowGWnd(true);
    m_btnCharacter->ShowGWnd(true);
    m_btnQuest->ShowGWnd(true);
    m_btnApprentice->ShowGWnd(true);

    m_IRM.GetResObj(GDR_MAINPOPUP_LEFT_DECO_STATIC, 1)->ShowGWnd(true);
#endif
