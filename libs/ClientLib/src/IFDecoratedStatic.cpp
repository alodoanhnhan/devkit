...
void CIFDecoratedStatic::sub_634300()
{
    reinterpret_cast<void(__thiscall*)(CIFDecoratedStatic*)>(0x00634300)(this);
}
std::n_string CIFDecoratedStatic::FUN_00633940()
{
    return N00009BFD;
}
void CIFDecoratedStatic::set_N00009BFD(std::n_string a1)
{
    N00009BFD = a1;
}
...
void CIFDecoratedStatic::set_wndsize(int w , int h)
{
    N00009BD5 = w;
    N00009BD8 = h;
}
void CIFDecoratedStatic::set_field_394(int a1)
{
    field_394 = a1;
}
