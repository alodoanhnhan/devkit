...
typedef void(APIENTRY* MoveTo)(uregion* region, D3DVECTOR* coord);

extern MoveTo HookMoveTo;
...
public:
   ...
   // void MoveTo(uregion &region, D3DVECTOR &coord);
    ...
    void MoveTo(uregion region, D3DVECTOR coord);
    void MoveToD3D(D3DVECTOR coord);
    void MoveToHook(uregion *region, D3DVECTOR *coord);
    static DWORD WINAPI  AutoMove(PVOID pParam);
private:
