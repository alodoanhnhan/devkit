...
public:
    ...
    std::wstring* GetStringTextByCode(std::wstring* NameStrID);

    static CTextStringManager* Get();
};
...
#define TSM_GETTEXTPTR1(text) (g_CTextStringManager->GetString(text)->c_str())
#define TSM_GETTEXT1(text) (g_CTextStringManager->GetString(text))
