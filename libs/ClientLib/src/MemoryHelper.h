...
public:
    ...
    BOOL SetTrampoline(bool isLongJmp, void* src, void* dest, UINT32 nopSize);
    ...
    static void ReplaceByte(void* addr, UINT8 value);
    /*JMP = FALSE CALL = TRUE*/
...
#endif
inline void MemoryHelper::ReplaceByte(void* addr, UINT8 value)
{
