	...
	: m_FontTexture()
{
  ...
  this->sub_655B00(L"");//interface\ifcommon\com_job_thief.ddj
...
void CTextBoard::TB_Func_2()
{
    ...
    //reinterpret_cast<void(__thiscall*)(CTextBoard*)>(0x00655d50)(this);
...
void CTextBoard::TB_Func_13x(const std::string str, int a3, int a4)
{
