...
public:
    ...
    void OnGameNotify(class MsgStreamBuffer* msg);
private:
    /// \address 008a6e80
    ...
    void OnChatItemInfo(CMsgStreamBuffer& msg);

public:
    void ProcessItemMovementResult(void* incomingPacket);
private:
...
extern CNetProcessIn* p_CNetProcessIn;